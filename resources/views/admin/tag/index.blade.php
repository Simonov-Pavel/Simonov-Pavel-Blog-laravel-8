...
@section('title', 'Админ панель-тэги')
@section('content')
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<a href="{{ route('admin.tags.show', $tag->id) }}" title="Смотреть"><i class="far fa-eye"></i></a>
										</td>
										<td class="text-center">
											<a href="{{ route('admin.tags.edit', $tag->id) }}" class="text-success" title="Редактировать"><i class="fas fa-pencil-alt"></i></a>
										</td>
										<td class="text-center">
